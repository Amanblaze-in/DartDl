...
- Migrated to Scoped Storage for all download operations using a "Private Temp -> Public Destination" architecture.
- Implemented 16 KB page alignment support for native libraries to ensure compatibility with modern Android devices.
...
### Added
- FULL AdMob Integration (Native, Interstitial, Rewarded, App Open)
- High-Resolution (1080p+) download gating (2 free per day, unlimited via Rewarded Ads)
- Integrated Privacy Policy in navigation drawer

### Fixed
- Fixed persistent "Downloading" notification bug after cancellation
- Improved background service lifecycle and unbinding logic
- Fixed compilation errors in Play Store release build
- Resolved minor UI inconsistencies in the Action Sheet
