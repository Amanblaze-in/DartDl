...
import com.dartdl.app.util.PreferenceStrings.getUpdateIntervalText
...
import com.dartdl.app.util.UpdateIntervalList
import com.dartdl.app.util.YT_DLP_AUTO_UPDATE
import com.dartdl.app.util.YT_DLP_NIGHTLY
import com.dartdl.app.util.YT_DLP_STABLE
import com.dartdl.app.util.YT_DLP_UPDATE_CHANNEL
                    ...
                    item {
                        ...
                        ExposedDropdownMenuBox(
                            ...
                            OutlinedTextField(
                                    ...
                                    onValueChange = {},
                                    label = {
                                        Text(text = stringResource(id = R.string.auto_update))
                                    },
                                    readOnly = true,
