...
import com.dartdl.app.database.backup.BackupUtil.BackupDestination
import com.dartdl.app.database.backup.BackupUtil.BackupType
import com.dartdl.app.ui.component.DartDLDialog
import com.dartdl.app.ui.component.DialogSubtitle
import com.dartdl.app.ui.component.SingleSelectChip
...
private fun PreviewExport() {
    DartDLTheme { ExportDialog() { _, _ -> } }
}

@Preview(uiMode = Configuration.UI_MODE_NIGHT_YES, name = "Dark")
@Composable
private fun PreviewImport() {
    DartDLTheme { ImportDialog() { _ -> } }
}
