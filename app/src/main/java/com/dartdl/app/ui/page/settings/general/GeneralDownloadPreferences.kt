package com.dartdl.app.ui.page.settings.general
...
import com.dartdl.app.ui.component.PreferenceSwitchWithDivider
import com.dartdl.app.ui.page.download.NotificationPermissionDialog
import com.dartdl.app.util.CONFIGURE
import com.dartdl.app.util.CUSTOM_COMMAND
import com.dartdl.app.util.DEBUG
import com.dartdl.app.util.DISABLE_PREVIEW
import com.dartdl.app.util.DOWNLOAD_ARCHIVE
import com.dartdl.app.util.FileUtil.getArchiveFile
import com.dartdl.app.util.NOTIFICATION
import com.dartdl.app.util.NotificationUtil
import com.dartdl.app.util.PLAYLIST
import com.dartdl.app.util.PRIVATE_MODE
...
import com.dartdl.app.util.SPONSORBLOCK
...
fun GeneralDownloadPreferences(onNavigateBack: () -> Unit, navigateToTemplate: () -> Unit) {
        ...
        Scaffold(
                ...
                topBar = {
                        LargeTopAppBar(
                                title = {
                                        Text(text = stringResource(id = R.string.general_settings))
                                },
                        ...
                        LazyColumn(modifier = Modifier, contentPadding = it) {
                                ...
                                item {
                                        ...
                                        PreferenceItem(
                                                title =
                                                        stringResource(
                                                                id = R.string.ytdlp_update_action
                                                        ),
                                ...
                                item {
                                        PreferenceSwitch(
                                                title =
                                                        stringResource(
                                                                id = R.string.download_notification
                                                        ),
                                                description =
                                                        stringResource(
                                                                id =
                                                ...
                                                onClick = {
                                                        if (notificationPermission?.status is
                                        ...
                                        PreferenceSwitch(
                                                title =
                                                        stringResource(
                                                                id =
                                                                        R.string
                                                                                .settings_before_download
                                                        ),
                                                description =
                                                        stringResource(
                                                                id =
                                                                        R.string
                                                                                .settings_before_download_desc
                                                        ),
                                                icon =
                                                        if (configureBeforeDownload)
                                ...
                                item {
                                        var thumbnailSwitch by remember {
                                                mutableStateOf(THUMBNAIL.getBoolean())
                                        }
                                        PreferenceSwitch(
                                                title =
                                                        stringResource(
                                                                id = R.string.create_thumbnail
                                                        ),
                                                description =
                                                        stringResource(
                                                                id =
                                                                        R.string
                                                                                .create_thumbnail_summary
                                                        ),
                                ...
                                item {
                                        PreferenceSwitch(
                                                ...
                                                description =
                                                        stringResource(R.string.print_details_desc),
                                                icon =
                                ...
                                item {
                                        PreferenceSwitch(
                                                ...
                                                description =
                                                        stringResource(R.string.private_mode_desc),
                                                icon =
                                ...
                                item {
                                        PreferenceSwitch(
                                                ...
                                                description =
                                                        stringResource(
                                                                R.string.download_playlist_desc
                                                        ),
                                ...
                                item {
                                        PreferenceSwitchWithDivider(
                                                ...
                                                description =
                                                        stringResource(R.string.sponsorblock_desc),
