...
import com.dartdl.app.Downloader.State
import com.dartdl.app.Downloader.manageDownloadError
import com.dartdl.app.Downloader.updatePlaylistResult
...
class HomePageViewModel : ViewModel() {
    ...
    fun startDownloadVideo() {
        ...
        if (url.isBlank()) {
            context.makeToast(context.getString(R.string.url_empty))
            return
        }
