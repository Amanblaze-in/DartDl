package com.dartdl.app.ui.theme
...
@Composable
@Deprecated("Use DartDLTheme instead", replaceWith = ReplaceWith("DartDLTheme(content)"))
fun PreviewThemeLight(content: @Composable () -> Unit) {
    DartDLTheme(darkTheme = false, content = content)
}
