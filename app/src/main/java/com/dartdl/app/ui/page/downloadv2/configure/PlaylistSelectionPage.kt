...
import com.dartdl.app.ui.component.PlaylistItem
import com.dartdl.app.ui.page.download.PlaylistSelectionDialog
...
fun PlaylistSelectionPage(
    ...
    val onDismissConfigurationSheet: () -> Unit = {
        scope.launch { configureSheetState.hide() }.invokeOnCompletion {
                                    ...
                                    onClick = {
                                        ...
                                        onConfirmSelection(
                                                TaskFactory.createWithPlaylistResult(
                                                        playlistUrl = result.originalUrl
                                                                        ?: result.webpageUrl
                                                                                .toString(),
